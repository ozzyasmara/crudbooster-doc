...
@section("content")
    ...
    <p>cURL is a way you can hit a URL from your code to get a HTML response from it. It's used for command line cURL from the PHP language. cURL is a library that lets you make HTTP requests in PHP</p>

    <p>You can use this built in helper to help you make a request with cURL</p>
